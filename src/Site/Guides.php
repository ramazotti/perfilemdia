    ...
    public static function clientSteps(): array
    {
        return [
            ...
            [
                ...
                'body' => 'Publicar manda para o Instagram. Ajustar serve para dizer o que mudar. Outra versão pede um texto novo. Você também pode escrever a legenda do seu jeito. Nada sai sem esse toque. Nos planos Profissional e Estúdio, Texto na foto escreve uma frase curta em cima da imagem, no estilo Cursiva, Clássica, Limpa, Forte, Balão ou Caixa, nas cores dourado, branco ou preto. Balão desenha um balão branco com o texto preto. Caixa desenha uma tarja preta com letra de máquina. O bot pergunta o lugar: topo, meio ou rodapé. O padrão é o rodapé. Marca d\'água coloca a foto do Instagram em um círculo, ou a logo que você enviar, no canto que você escolher. Agendar marca o dia e a hora, e o bot publica sozinho. Dá para escolher um horário pronto ou escrever só a hora, ou o dia e a hora. O menu da prévia segue até o post sair. Tratar foto muda a imagem com IA, e a frase entre aspas também entra em cima da foto. O post criado pela IA segue a mesma regra: só publica quando você toca em Publicar, ou na hora agendada.',
